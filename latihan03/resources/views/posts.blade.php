...
@section('container')
    ...
    <h1 class="mb-3 d-flex justify-content-center">{{ $title }}</h1>
        ...
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div style="max-height: 200px; overflow:hidden">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" class="card-img-top" alt="{{ $posts[0]->category->name }}" height="300">
                </div>
            @else
                <img src="https://source.unsplash.com/1000x200?{{ $posts[0]->category->name }}" class="card-img-top" alt="{{ $posts[0]->category->name }}" height="300">
            @endif

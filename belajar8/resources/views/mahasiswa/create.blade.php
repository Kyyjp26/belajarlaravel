                ...
                <form action="{{ route('mahasiswas.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="jurusan" id="jurusan" class="form-select" value="{{ old('jurusan') }}">
                            ...
                            <option value="Ilmu Komputer" {{ old('jurusan')=='Ilmu Komputer' ? 'selected': 'Ilmu Komputer' }}>Ilmu Komputer</option>
                            <option value="Teknik Komputer" {{ old('jurusan')=='Teknik Komputer' ? 'selected': 'Teknik Komputer' }}>Teknik Komputer</option>
                    ...
                    <button class="btn btn-primary mb-2" type="submit">Daftar</button>
                </form>
            </div>
        </div>
    </div>
